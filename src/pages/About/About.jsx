    ...
    return (
        ...
        <section className="">
          <div className="container px-6 py-10 mx-auto">
            <section className="mt-8 space-y-8 lg:mt-12">
              <section className="lg:flex lg:items-center gap-10">
                <div className="lg:w-1/2 text-center ">
                  ...
                  <h2 className="mt-2 text-xl font-light  text-black">
                    ...
                    difference. Together, we are driven by a shared vision of
                    excellence, sustainability, and customer satisfaction. Our
                    slogan, 'Transforming Ideas into Reality,' encapsulates our
                    commitment to turning innovative concepts into tangible
                    solutions. We believe that through collaboration,
                    determination, and a relentless pursuit of quality, we can
                    create a brighter future for our customers, employees, and
                    communities."{" "}
                  </h2>
                </div>
                ...
                <div className="mt-4 lg:w-1/2 lg:mt-0">
                  <img
                    className="object-cover w-96 h-64 rounded-lg md:h-96"
                    src="https://images.unsplash.com/photo-1585807515950-bc46d934c28b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                    alt=""
                  />
                </div>
              </section>
              ...
              <section className="lg:flex lg:items-center gap-10 ">
                <div className="mt-44 lg:w-1/2 lg: ">
                  <img
                    className="object-cover w-96 h-64 rounded-lg md:h-96 -mr-60 "
      ...
      <div className="container px-6 py-10 mx-auto">
          ...
          <p className="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
              Lorem ipsum dolor sit that is  elit. Illo incidunt ex placeat modi magni quia error alias, adipisci rem similique, at omnis eligendi optio eos harum.
          </p>
