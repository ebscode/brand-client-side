        ...
        <div className="flex flex-col justify-center p-10 bg-white rounded-lg shadow-2xl card">
            ...
            <div className="grid gap-10 prod-info">
                ...
                <div className="flex flex-col items-center justify-between text-gray-900 md:flex-row">
                    ...
                    <button onClick={handleaddcart} className="px-6 py-2 uppercase transition duration-200 ease-in border-2 border-gray-900 rounded-full hover:bg-gray-800 hover:text-white focus:outline-none">
                        Add to cart
                    </button>
                </div>
            </div>
