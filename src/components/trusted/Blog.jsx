...
const Blog = () => {
	...
	<div className="container p-6 mx-auto space-y-8">
		<div className="space-y-2 text-center">
			<h2 className="text-3xl font-bold dark:text-white">Latest technology news & articles</h2>
		...
		<div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
			<article className="flex flex-col ">
				...
				<div className="flex flex-col flex-1 p-6">
					...
					<h3 className="flex-1 py-2 text-lg font-semibold dark:text-gray-300">7 years of software updates for the Pixel 8 series</h3>
			...
			<article className="flex flex-col ">
				...
				<div className="flex flex-col flex-1 p-6">
					<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
					<a rel="noopener noreferrer" href="#" className="text-xs tracki uppercase hover:underline dark:text-blue-400">read</a>
					<h3 className="flex-1 py-2 text-lg font-semibold dark:text-gray-300">Galaxy Z Flip5 and Z Fold5: Delivering Positive Impact for the Planet</h3>
					<div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
			...
			<article className="flex flex-col ">
				...
				<div className="flex flex-col flex-1 p-6">
					<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
					<a rel="noopener noreferrer" href="#" className="text-xs tracki uppercase hover:underline dark:text-blue-400">read</a>
					<h3 className="flex-1 py-2 text-lg font-semibold dark:text-gray-300">Sony Xperia Pro-II May Shockingly Sport a Dual 1-inch Camera</h3>
					<div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
			...
			<article className="flex flex-col ">
				...
				<div className="flex flex-col flex-1 p-6">
					<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
					<a rel="noopener noreferrer" href="#" className="text-xs tracki uppercase hover:underline dark:text-blue-400">read</a>
					<h3 className="flex-1 py-2 text-lg font-semibold dark:text-gray-300">Surface Laptop 5 – “Premium and simply gorgeous”</h3>
					<div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
